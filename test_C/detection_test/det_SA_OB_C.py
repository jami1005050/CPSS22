...
dataframe_tau_Q = pd.read_csv('../../robust/tau_generation_OPT_BETA/SA_tau_C_Q_U.csv')
dataframe_tau_NQ = pd.read_csv('../../robust/tau_generation_OPT_BETA/SA_tau_C_NQ_U.csv')
...
tau_result_frame.to_csv('det_SA_Q_C_add.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_SA_Q_C_ded.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_SA_NQ_C_add.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_SA_NQ_C_ded.csv')
