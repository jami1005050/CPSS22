import pandas as pd
det_RA_L1 = pd.read_csv('det_RA_Q_C_ded.csv')
det_RA_L2 = pd.read_csv('det_RA_NQ_C_ded.csv')
...
fa_ra_ar_frame_l1.to_csv('RA_NDA_Q_C.csv')
...
fa_ra_ar_frame_l2.to_csv('RA_NDA_NQ_C.csv')
