...
f = open('../result_data/detection/detection_poisoned_C_non_Q_K2_small_step_del.json')
...
with open("../result_data/impact/impact_poisoned_C_non_Q_K2_small_step_del.json", "w") as outfile:
