...
det_Q_ded = pd.read_csv('../detection_test/det_RA_QC_ded_12_03_21_M10M12.csv')
# det_NQ_add = pd.read_csv('../detection_test/det_RA_NQ_C_add.csv')
det_NQ_ded = pd.read_csv('../detection_test/det_RA_NQC_ded_12_03_21_M10M12.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_RA_QC_ded_12_03_21_M10M12.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_RA_NQC_ded_12_03_21_M10M12.csv')
print(tau_result_frame['impact'].mean())
