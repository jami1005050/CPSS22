...
f = open('../result_data/detection/detection_poisoned_CRA_non_Q_small_Step_del.json')
...
with open("../result_data/impact/impact_poisoned_CRA_non_Q_small_step_del.json", "w") as outfile:
