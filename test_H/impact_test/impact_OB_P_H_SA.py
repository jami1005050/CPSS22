...
det_Q_ded = pd.read_csv('../detection_test/det_SA_QH_ded_12_03_21_M10M12.csv')
# det_NQ_add = pd.read_csv('../detection_test/det_SA_NQ_H_add.csv')
det_NQ_ded = pd.read_csv('../detection_test/det_SA_NQH_ded_12_03_21_M10M12.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_QH_ded_12_03_21_M10M12.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_NQH_ded_12_03_21_M10M12.csv')