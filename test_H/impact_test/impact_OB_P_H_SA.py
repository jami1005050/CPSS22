...
det_Q_ded = pd.read_csv('../detection_test/det_SA_Q_H_ded.csv')
det_NQ_add = pd.read_csv('../detection_test/det_SA_NQ_H_add.csv')
det_NQ_ded = pd.read_csv('../detection_test/det_SA_NQ_H_ded.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_Q_H_ded.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_NQ_H_ded.csv')