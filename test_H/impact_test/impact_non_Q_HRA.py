...
f = open('../result/detection/detection_poisoned_HRA_non_Q_small_step_del.json')
...
with open("../result/impact/impact_poisoned_HRA_non_Q_small_step_del.json", "w") as outfile:
