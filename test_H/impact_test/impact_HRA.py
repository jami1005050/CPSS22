...
f = open('../result/detection/detection_poisoned_HRA_Small_step_del.json')
...
for key2 in poisoning_std_limits.keys(): # del
    ...
    for key3 in poisoning_std_limits[key2].keys(): #del use when you are doing small scale attack
        result[key2][key3] = {}
...
with open("../result/impact/impact_poisoned_HRA_small_step_del.json", "w") as outfile:
