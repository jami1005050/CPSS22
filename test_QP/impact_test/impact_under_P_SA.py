...
det_l1_ded = pd.read_csv('../detection_test/det_SA_L1_ded_12_03_21_M4M6.csv')
# det_l2_add = pd.read_csv('../detection_test/det_SA_L2_add.csv')
det_l2_ded = pd.read_csv('../detection_test/det_SA_L2_ded_12_03_21_M4M6.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_L1_ded_12_03_21_M4M6.csv')
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('impact_SA_L2_ded_12_03_21_M4M6.csv')