...
# dataframe_add_l1 = pd.read_csv('../../robust/tau_generation_OPT_BETA/RA_tau_L1_add.csv')
dataframe_ded_l1 = pd.read_csv('../../robust/tau_generation_OPT_BETA/RA_tau_L1_ded.csv')
# dataframe_add_l2 = pd.read_csv('../../robust/tau_generation_OPT_BETA/RA_tau_L2_add.csv')
dataframe_ded_l2 = pd.read_csv('../../robust/tau_generation_OPT_BETA/RA_tau_L2_ded.csv')
testing_residual_benign = pd.read_csv("../../data/test_ruc/test_residuals/Test_RUC_Benign.csv")  # 91-181

# result_array = []
# for index,row in dataframe_add_l1.iterrows():
...
# tau_result_frame.to_csv('det_RA_L1_add.csv')

result_array = []
for index, row in tqdm(dataframe_ded_l1.iterrows(),desc='progress l1'):
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_RA_L1_ded_12_03_21_M10M12.csv')

# result_array = []
# for index, row in dataframe_add_l2.iterrows():
#     for del_evg_te in DEL_AVG_ARRAY_ADD_TE:
...
#
# tau_result_frame = pd.DataFrame(result_array)
# tau_result_frame.to_csv('det_RA_L2_add.csv')

result_array = []
for index, row in tqdm(dataframe_ded_l2.iterrows(),desc='progress l2'):
    for del_evg_te in DEL_AVG_ARRAY_DED_TE:
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_RA_L2_ded_12_03_21_M10M12.csv')