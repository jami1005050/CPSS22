...
result_array = []
for index, row in dataframe_ded_l1.iterrows():
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_RA_L1_ded.csv')
...
result_array = []
for index, row in dataframe_ded_l2.iterrows():
    for del_evg_te in DEL_AVG_ARRAY_DED_TE:
...
tau_result_frame = pd.DataFrame(result_array)
tau_result_frame.to_csv('det_RA_L2_ded.csv')