...
m_efa_l1 = impact_l1_ded['efa_m'].mean()
m_efa_l2 = impact_l2_ded['efa_m'].mean()
m_efa_QC = impact_Q_C_ded['efa_m'].mean()
m_efa_NQC = impact_NQ_C_ded['efa_m'].mean()
m_efa_QH = impact_Q_H_ded['efa_m'].mean()
m_efa_NQH = impact_NQ_H_ded['efa_m'].mean()
...
#                impact_Q_C_ded['impact_m'],label ='QC',color='tab:olive', alpha = 1.0) #alpha=0.5,
#
# q= ax.plot_trisurf(impact_NQ_C_ded['del_avg_tr'],
#                impact_NQ_C_ded['ro_mal'],  #     cmap=matplotlib.cm.inferno,antialiased=True,
#                impact_NQ_C_ded['impact_m'],label='NQC',color='tab:blue', alpha = 1.0)#alpha=0.5,
...
# ax.set_zlim3d(min(impact_NQ_C_ded['impact_m']),1300)
