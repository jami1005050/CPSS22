...
# plt.plot(train_t_max_list, train_t_max_loss_list, 'b-')
# plt.plot(attack_t_max_list, attack_t_max_loss_list, 'r-')
...
# plt.show()
#
# # plt.plot(train_t_min_list, train_t_min_loss_list, 'b-')
# plt.plot(attack_t_min_list, attack_t_min_loss_list, 'r-')
...
# plt.show()
#
# # plt.plot(ruc_frame_training["day"], ruc_frame_training["ruc2014"], '.b--')
# # plt.plot(ruc_frame_training["day"], ruc_frame_training["ruc2015"], '^r--')
...
# # plt.plot(ruc_frame_training["day"], ruc_frame_training["ruc2014"], '.b--')
# # plt.plot(ruc_frame_attacked["day"], ruc_frame_attacked["ruc2014"], '^r--')
# # plt.hlines(train_t_max, 0, 365, linestyles='dashed')
# # plt.hlines(train_t_min, 0, 365, linestyles='dashed')
# # plt.xlabel('Days')
# # plt.ylabel('RUC')
...
# # plt.show()
#
# # plt.plot(ruc_frame_training["day"], ruc_frame_training["ruc2015"], '.b--')
# # plt.plot(ruc_frame_attacked["day"], ruc_frame_attacked["ruc2015"], '^r--')
# # plt.hlines(train_t_max, 0, 365, linestyles='dashed')
# # plt.hlines(train_t_min, 0, 365, linestyles='dashed')
# # plt.xlabel('Days')
# # plt.ylabel('RUC')
