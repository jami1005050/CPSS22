...
f_Q = open('../test_QP/impact_poisoned_ro_del_QRA.json' )
f_QL2 = open('../test_QP/impact_poisoned_ro_del_L2_QRA.json' )
...
impact= result_frame[( result_frame['tr_del_avg'] == str(175)) &
                     ( result_frame['del_avg'] == str(190))
                     &( result_frame['romal'] > str(0.30))]#
...
impact_nQ= result_frame[( result_frame['tr_del_avg'] == str(175) )
                        & ( result_frame['del_avg'] == str(190))
                        &( result_frame['romal'] > str(0.30))]#
...
# plt.plot(impact_nQ['del_avg'],impact_nQ['impact_H'],marker ='>',color = 'r',label = 'NQH')
