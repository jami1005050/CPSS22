...
class ExistingDefense:
    ...
    def training(self, TRAINING_DATA,threshold):
        ...
        self.tmax_ruc = calculateTmax_QR(residual_frame_no_attack, TRAINING_DATA.keys())# non attacked standard limit max margin
        self.tmin_ruc = calculateTmin_QR(residual_frame_no_attack, TRAINING_DATA.keys()) # non attacked standard limit min margin
