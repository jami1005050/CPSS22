...
plt.ylim(0,11)
plt.xlim(0,0.13)
not_attack = pd.read_csv('../data/loss_vs_std/loss_vs_tmin_l1.csv', names=['std_limit', 'loss'], header=None)
...
plt.xlabel(r'$\tau$-')
plt.ylabel("Loss")
# locator = matplotlib.ticker.MultipleLocator(6)
# plt.gca().xaxis.set_major_locator(locator)
# plt.title("Histogram of IQ: " r'$\mu = 100, \sigma$ =15')

plt.legend(["Benign","FGAV"])
plt.show()
